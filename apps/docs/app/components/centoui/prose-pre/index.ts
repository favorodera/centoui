...
export const prosePreVariants = tv({
  ...
  slots: {
    code: `
      ...
      **:[.line.highlight]:bg-accent! **:[.line.highlight]:inline-block
    ...
    header: `
      ...
      *:data-[slot=prose-code-icon]:mbs-0.5
    `,
    root: `
      group/prose-pre-root bg-muted rounded-xl border bg-clip-padding relative
      grid
    `,
  },
  variants: {
