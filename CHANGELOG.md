...
- **storybook:** Add custom theme editor ([6888517](https://github.com/favorodera/centoui/commit/6888517))

  - Allow users to edit and live-preview CSS themes
  - Persist custom theme modifications in storage
  - Provide theme reset and copy controls in header
...
- **docs:** Add navigation menu and prose components ([6ea63db](https://github.com/favorodera/centoui/commit/6ea63db))

  - Add NavigationMenu and Prose markdown components
  - Update component styles and font sizes across UI
  - Replace NuxtIcon with Iconify Vue icon component
...
- **docs:** Add basic documentation page rendering ([069d945](https://github.com/favorodera/centoui/commit/069d945))

  - Introduce dynamic docs page routing
  - Define 'docs' content collection with schema
  - Add initial 'Getting Started' documentation content
...
- **docs:** Add responsive mobile navigation ([c89ff69](https://github.com/favorodera/centoui/commit/c89ff69))

  - Add mobile drawer menu to header component
  - Adjust docs layout and grids for small screens
  - Hide sidebar on mobile viewports
  - Improve typography flow and page header spacing
...
- **docs:** Enable Nuxt Content's default prose styling ([d7eaeae](https://github.com/favorodera/centoui/commit/d7eaeae))

  - Removes redundant :prose="false" attribute
  - Improves content rendering consistency


### Refactors

- **storybook:** Polish navigation-menu story ([f25ddf1](https://github.com/favorodera/centoui/commit/f25ddf1))

  - Update mock data to reflect realistic use cases
  - Add eyebrow support to featured items
  - Replace inline CSS with Tailwind classes
  - Polish layout alignment and typography spacing


### Documentation

- **app:** Improve documentation layout and content ([7105383](https://github.com/favorodera/centoui/commit/7105383))

  - Add custom typography styles and utilities
  - Implement reusable DocsPageHeader component
  - Enhance layout with sidebar and TOC slots
  - Update button guide and overview content
  - Remove placeholder documentation files


### Chores

- **docs:** Temporarily hide unused navigation links ([b164d57](https://github.com/favorodera/centoui/commit/b164d57))
...
- **docs:** Remove grid class from main wrapper ([31dc3b6](https://github.com/favorodera/centoui/commit/31dc3b6))
...
- **storybook:** Improve component selector usability ([ff90a77](https://github.com/favorodera/centoui/commit/ff90a77))

  - Enable open-on-click for combobox
  - Update placeholder text for better clarity

- **storybook:** Add showClear control to combobox story ([343b207](https://github.com/favorodera/centoui/commit/343b207))

  - Add showClear boolean control to combobox
  - Refactor story data structure for clarity
...
- **storybook:** Add separator to sheet story ([aa5d9ae](https://github.com/favorodera/centoui/commit/aa5d9ae))

  - Add separator component to sheet story example
  - Improve visual structure of sheet content
...
- **storybook:** Remove unnecessary data-slot attribute ([6bc78eb](https://github.com/favorodera/centoui/commit/6bc78eb))

  - Remove redundant attribute from ComboboxInput
  - Clean up storybook component configuration
...
- **storybook:** Add field component story ([7aa903a](https://github.com/favorodera/centoui/commit/7aa903a))
...
- **storybook:** Add form integration to field story ([8a3c895](https://github.com/favorodera/centoui/commit/8a3c895))

  - integrate notform for field validation
  - add input and button components to story
  - implement form submission and reset logic
...
- **storybook:** Add payment form example to field story ([6158c63](https://github.com/favorodera/centoui/commit/6158c63))

  - implement payment form fields with validation
  - add card number, expiration, and cvv inputs
  - integrate field error and description components
  - update form schema with zod validation rules
...
- **storybook:** Add invalid state to fields ([13877d8](https://github.com/favorodera/centoui/commit/13877d8))

  - apply data-invalid prop based on field validation
  - improve visual feedback for form errors

- **storybook:** Add address, checkbox, and textarea fields ([7c2da8c](https://github.com/favorodera/centoui/commit/7c2da8c))

  - Add new form fields to the Field story
  - Implement validation schema for new inputs
  - Enable testing of address and comment fields

- **storybook:** Add address, checkbox, and textarea fields ([709b35a](https://github.com/favorodera/centoui/commit/709b35a))

  - Add new form fields to the Field story
  - Implement validation schema for new inputs
  - Enable testing of address and comment fields

- **storybook:** Update field story components and schema ([1e23c98](https://github.com/favorodera/centoui/commit/1e23c98))

  - Replace FieldLabel with Label component
  - Add Switch component for notification settings
  - Update form schema and initial values
  - Refactor field layout and validation attributes
...
- **storybook:** Add notform dependency to catalog ([3c08127](https://github.com/favorodera/centoui/commit/3c08127))
...
- **storybook:** Update overlay background color ([2f20318](https://github.com/favorodera/centoui/commit/2f20318))

  - change bg-overlay to bg-scrim in body component
...
- **storybook:** Add checkbox component story ([9458456](https://github.com/favorodera/centoui/commit/9458456))

  - create new checkbox story file
  - add interactive controls for checkbox props
...
- **renovate:** Update configuration preset path ([fb029c5](https://github.com/favorodera/centoui/commit/fb029c5))
...
- Bump CentoUI version to 0.2.2 ([cfa9eae](https://github.com/favorodera/centoui/commit/cfa9eae))
- Add vitest and @vitest/ui dependencies ([3e894d4](https://github.com/favorodera/centoui/commit/3e894d4))
